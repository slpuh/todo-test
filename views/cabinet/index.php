                            ...
                            <?php if ($task['parent_id'] == 0) : ?>
                                <div class="col-4">
                                    <div class="block-item card-task">
                                        ...
                                        <div class="info-item status status-process h3-main date-task"><?= date("d.m.y H:i", strtotime($task['finish'])); ?></div>
                                            ...
                                            <?php foreach ($subTasks as $subTask) : ?>
                                                <?php if ($subTask['parent_id'] == $task['id']) : ?>
                                                    <div class="block-item card-subtask">
                                                        <div class="info-item status status-process h3-main date-task"><?= date("d.m.y H:i", strtotime($subTask['finish'])); ?></div>
